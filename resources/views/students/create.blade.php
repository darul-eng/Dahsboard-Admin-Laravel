                ...
                <div class="col-8">
                  ...
                  <form method="POST" action="/students">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Student Name" name="nama" value="{{ old('nama') }}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('jurusan') is-invalid @enderror" id="jurusan" placeholder="Departement" name="jurusan" value="{{ old('jurusan') }}">
